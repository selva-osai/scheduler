$(document).ready(function () {
    //$("[ID$='chkInactive']").live('click', function (e) {
    $(".dummycss").live('click', function (e) {
    ...
    $('.gridIco1').live('click', function (e) {
        var webinarID = $(this).attr('data-webid');
    ...
    $("#ContentPlaceHolder1_webinarlist1_AdvancedSearch").live('click', function (e) {
        var URL = "/Pages/AdSearchWebinar";
        
        qtipPopup2("#ContentPlaceHolder1_webinarlist1_AdvancedSearch",
                    "<div id='modalContainer'><div class='modalClose'><img src='/images/x.png' /></div><iframe id='popFrame4' src=" + URL + " height='255' width='550' scrolling='no' class='bgfill'></iframe></div>",
